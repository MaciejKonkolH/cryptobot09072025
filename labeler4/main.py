...
try:
    import labeler4.config as config
except ImportError:
    import config
...
def setup_logging():
    ...
    logging.basicConfig(
        ...
        handlers=[
            logging.FileHandler(os.path.join(log_dir, config.LOG_FILENAME), encoding='utf-8'),
...
class MultiLevelLabeler:
    ...
    def __init__(self):
        ...
        logger.info("MultiLevelLabeler (labeler4) zainicjalizowany.")
